    ...
    >
      <div className="max-w-7xl flex flex-row items-center mx-auto px-4 py-2 gap-2">
        ...
        <Link href="/" className="leading-0" tabIndex={-1} aria-hidden={true}>
          <Logo className="h-12 cursor-pointer" alt="Tranic" />
          {/*<LogoMarkerLight
        ...
        >
          <NavDropDown label="Software">
            <NavDropDownLink href="/software/levelbukkit" eol>
              LevelBukkit
            </NavDropDownLink>
            <NavDropDownLink href="/software/vine">Vine</NavDropDownLink>
            <NavDropDownLink href="/software/sewlia">Sewlia</NavDropDownLink>
          </NavDropDown>
          <NavLink
            href="https://docs.tranic.one/"
            target="_blank"
        ...
        <IconButton
          icon={GitHubIcon}
          label="GitHub"
          href={softwareProps?.github || "https://github.com/LevelTranic"}
          external
        />
      </div>
    </nav>
